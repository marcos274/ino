    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <a href="../../index2.html" class="logo">
                ...
                <span class="logo-lg"><b>MH©Sys</b></span>
            </a>
            ...
            <nav class="navbar navbar-static-top">
                ...
                <div class="navbar-custom-menu">
                    ...
                    <!-- Se imprime el nombre del usuario que incio sesion  -->
                    ...
                    <!-- aqui se direcciona a un metodo en el controlador auth de nombre logout para cerrar sesion -->
