...
class Ventas_model extends CI_Model {
	...
	public function getVentas(){
		...
		$this->db->join("clientes c","v.cliente_id = c.id_cliente");
	...
	public function getVenta($id){
		$this->db->select("v.*,c.nombre_cliente,c.direccion_cliente,c.telefono_cliente,c.num_doc_cliente as documento,tc.nombre as tipocomprobante");
		$this->db->from("ventas v");
		$this->db->join("clientes c","v.cliente_id = c.id_cliente");
		$this->db->join("tipo_comprobante tc","v.tipo_comprobante_id = tc.id");
	...
	public function getDetalle($id){
		$this->db->select("dt.*,p.cod_producto,p.descripcion_producto");
